...
void remote_uart_tx_interrupts_init(void)
{
    ...
    cyhal_uart_enable_event(&remote_uart_obj, CYHAL_UART_IRQ_TX_EMPTY | CYHAL_UART_IRQ_TX_TRANSMIT_IN_FIFO | CYHAL_UART_IRQ_TX_DONE | CYHAL_UART_IRQ_TX_ERROR, 7, false);
}
