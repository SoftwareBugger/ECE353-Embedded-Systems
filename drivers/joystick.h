...
#define JOYSTICK_THRESH_X_LEFT_2p7V 0xD174
#define JOYSTICK_THRESH_X_RIGHT_0p6V 0x2E8B
#define JOYSTICK_THRESH_Y_UP_2p7V 0xD174
#define JOYSTICK_THRESH_Y_DOWN_0p6V 0x2E8B
/* Custom Data Typtes */
typedef enum {
    JOYSTICK_POS_CENTER,
    JOYSTICK_POS_LEFT,
